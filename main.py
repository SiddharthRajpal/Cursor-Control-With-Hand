...
try:
    ...
    autopy.alert.alert(" Missing Library : PyAutoGUI \n Installing Required Libraries",title = "Installing PyAutoGUI")
...
confirm = pyautogui.confirm('Running This Program Can Cause Extreme frutration and cause you to yeet your cat.... are you sure you want to run this?', title = "Warning ⚠ " )
    ...
    while True:
        ...
        if result.multi_hand_landmarks:
            ...
            for num,hand in enumerate(result.multi_hand_landmarks):
                ...
                try:
                    autopy.mouse.move(xindex1*5, yindex1*5)
                except:
                    pass
